            ...
            <div class="d-flex row justify-content-between">
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nombre, descripción, n° de bien, estatus">
                        <button class="btn btn-success" type="button" id="button-addon2">Consultar</button>
                    </div>
                </div>
                <div class="col-sm-4">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#equipo">Registar nuevo equipo</button> 
                </div>             
            </div>
        </div>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#equipo">Editar</button>
                                    <button type="button" class="btn btn-sm btn-danger">Desincorporar</button>
                                </div>
                                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#mantenimiento">Mantenimiento</button>
                            </div>
                        </td>
                </tbody>
            </table>
                ...
                <div class="modal-body">
                    <form action="" class="row g-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="n_bien" id="bien">
                        </div>
                        <div class="col-sm-6">
